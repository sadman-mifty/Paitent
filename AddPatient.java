...
public class AddPatient extends JFrame implements MouseListener, ActionListener{
	...
	public AddPatient(PList pl){
		...
		f1 = new Font("Segoe UI", Font.BOLD, 30);
		f2 = new Font("Segoe UI", Font.BOLD, 18);
		...
		pIdLabel.setBounds(75,120,90,25);
		panel.add(pIdLabel);
			
		idFieldLabel = new JLabel("PID"+1001+pl.pCount);
		idFieldLabel.setBounds(170,118,200,25);
		panel.add(idFieldLabel);
			 
		pnLabel = new JLabel("Patient Name :");
		pnLabel.setBounds(75,150,90,25);
		panel.add(pnLabel);
			
		pnTF = new JTextField();
		pnTF.setBounds(170,151,200,25);
		panel.add(pnTF);
			
		mbLabel = new JLabel("Mobile Number :");
		mbLabel.setBounds(75,190,110,25);
		panel.add(mbLabel);
			
		mbTF = new JTextField();
		mbTF.setBounds(170,190,200,25);
		panel.add(mbTF);
			
		genLabel = new JLabel("Gender :");
		genLabel.setBounds(75,220,80,25);
		panel.add(genLabel);
			
		a1 = new JRadioButton("Male");
		a1.setBounds(165,222,60,25);
		a1.setBackground(c1);
		panel.add(a1);
			
		a2 = new JRadioButton("Female");
		a2.setBounds(235,222,80,25);
		a2.setBackground(c1);
		panel.add(a2);
			
		a3 = new JRadioButton("Other");
		a3.setBounds(310,222,80,25);
		a3.setBackground(c1);
		panel.add(a3);
		...
		ageLabel.setBounds(75,250,90,25);
		panel.add(ageLabel);
			
		ageTF = new JTextField();
		ageTF.setBounds(172,250,93,25);
		panel.add(ageTF);
			
		addLabel = new JLabel("Address :");
		addLabel.setBounds(75,280,90,25);
		panel.add(addLabel);
			
		addTF = new JTextField();
		addTF.setBounds(172,280,200,25);
		panel.add(addTF);

		String dr[] = {"Choose a Doctor", "Dr.Shamim.", "Dr.Alfaz", "Dr.Kazi" };
		 b1 = new JComboBox<String>(dr);
		 b1.setBounds(175,310,200,25);
		panel.add(b1);
			
			
		roomLabel = new JLabel("Allocated Room:");
		roomLabel.setBounds(75,340,100,25);
		panel.add(roomLabel);
			
		String rm[] = {"Choose a Room", "G-301", "G-302", "G-303", "G-304", "G-305","ICU-401", "ICU-402", "CCU-403", "CCU-404", "ICCU-501", "ICCU-502", "HDU-503","HDU-504"};
		 b2 = new JComboBox<String>(rm);
		 b2.setBounds(175,340,130,25);
		panel.add(b2);
			
		disLabel = new JLabel("Diagnosis :");
		disLabel.setBounds(75,390,90,25);
		panel.add(disLabel);
			
		disTF = new JTextField();
		disTF.setBounds(172,390,200,25);
		panel.add(disTF);
			
		depLabel = new JLabel("Deposit :");
		depLabel.setBounds(75,420,90,25);
		panel.add(depLabel);
			
		depTF = new JTextField();
		depTF.setBounds(172,420,200,25);
		panel.add(depTF);
